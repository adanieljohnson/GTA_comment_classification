...
**Extracting TAs' Comments** *(Early coding stage)*  
...
**Structure of Development Dataset; Data Import & Validation** *(Completed)*  
...
**Codebook for Classifying TAs' Comments** *(Completed)*  
...
**Initial Exploration of the Dataset** *(Partly completed)*  
...
**Current Version of the Naive Bayes Comment Classifier** *(Completed)*  
...
**Embedding the Naive Bayes Classifier in an Ensemble Model** *(Planning stage)*  
