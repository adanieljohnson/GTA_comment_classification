...
#Demonstration of Applying Naive Bayes Method
...
```{r}
#CSV file named "coded_full_comments_dataset_Spring18anon.csv" already has correctly organized text and meta-data. First line reads it in.
...
The "type"" element is a character. This changes it to a factor for the analysis.
