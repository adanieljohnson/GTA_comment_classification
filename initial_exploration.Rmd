...
#Overview
The first question to answer before making deeper comparisons is, **are word frequencies different between TAs' comments from different sub-categories?** To that end, I ran three different analyses of word usage frequency.
...
*  __N-grams mapping__. This identifies text strings, phrases, and terms that are unique (or nearly unique) to one sub-category. 
...
One of our earliest observations was that the n-gram "basic criteria" only appeared in TA comments from three different Subject sub-categories. This suggests certain terms and n-grams might be eliminated 

However it w  the relative frequency was much higher
```{}
#Pseudo-code
Import comments
