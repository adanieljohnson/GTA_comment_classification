...
The first question to answer before making deeper comparisons is **are TAs' comments obviously different between sub-categories?** To that end, I ran three different analyses of word usage in TA comments.

*  Pearson correlations for word use frequencies. This compares words found in all Subject sub-categories
*  Word frequency differences based on log-odds ratios. This highlights terms that are the most different between sub-categories.
*  Unique n-grams mapping. This identifies text strings, phrases, and rare terms that are unique (or nearly unique) to one sub-category.
...
##Are Shared Words Unequally Distributed?
...
#N-Grams Mapping 
##Which Terms, Phrases Are Unique to a Sub-Category?
