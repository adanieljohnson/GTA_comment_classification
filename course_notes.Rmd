...
**Option: Naive Bayes Text Classification**
...
Again, the we would need to de-identify the student and TA using some kind of firewalled search/replace functions. 
