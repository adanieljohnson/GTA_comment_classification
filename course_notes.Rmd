...
I have 11,000 comments from TAs on student reports. Process for bringing in the tidied data and structuring it for analysis is not done, but is coming along. 

I want to sort TA comments into topic groups more or less automatically, using pre-defined criteria. What are the options?
...
Challenge is that my groups are **already based on the existing coding book.** The individual groups are already labeled. LDA clusters items based on its own analysis.
...
Looking at Jerid's Intro to Statistical Thinking clarified some issues in my approach. I definitely need to be thinking about this problem more in terms of unsupervised exploration. 

That leads to my follow-up question: training with 80% seems excessive. If there is a large dataset, is there any cost or benefit to splitting to 33/33/34%, or even 25% x 4? The 80/20 and 60/20/20% seem out of balance, but there is probably logic I do not see. 
...
**What Are the Primary Data Keys For Structuring the Dataset?**
...
>Thank you x^y times over for the Regex101 link! Getting Regex right has been a pain for me! This greatly simplifies the process.  
