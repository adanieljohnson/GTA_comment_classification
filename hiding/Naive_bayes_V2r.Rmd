...
##Summary
This is **Version 2.0.r** of the basic workflow for classifying TA comments using a naive Bayes model. It pre-processes text using the same command set as Ver 2.0.b. The "r" designates this version has been modified to be able to randomize which rows are selected for training and test datasets.
