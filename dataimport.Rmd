...
Data were anonymized in Excel prior to conversion to CSV format. Names, email addresses, and other confidential information was replaced with unique randomized alphanumeric strings **[LINK]**. 
...
1.  Student and TA names have been recoded using pre-assigned anonymous IDs.
2.  Vocabulary terms used in coding columns matches criteria in "codebook_for_comments.rmd" [LINK]
3.  Data table headers match those listed below. The same list is in the file "code_column_names.rmd" [LINK]
