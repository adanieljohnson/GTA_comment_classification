...
##Summary
This is **Version 2.0.yn** of the basic workflow for classifying TA comments using a naive Bayes model. It is optimized for testing pair-wise assignment to categories (Yes/No decision) beginning with the most frequently encountered.
