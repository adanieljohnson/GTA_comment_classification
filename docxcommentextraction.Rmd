---
title: "DRAFT: DOCX Comment Extraction"
...
The testing dataset used in this project was created using BaSH scripting and one-off text processing. This page documents progress on building a workflow to replicate that process using R tools.
