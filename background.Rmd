...
In 2014 we launched an automated data collection process we call **SAWHET** that systematically collects structured writing and other data from student writers and graduate instructors. Our resarch goal is to better understand student and instructor behaviors within the technical writing instructional space. From this empirical basis our practical goal is to develop techniques for teaching technical writing that:
...
*  Embody other best practices from 40+ years of research literature on "writing in the disciplines."
